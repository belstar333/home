        ...
        sections: [
            ...
            section(
                ...
                imageGallery({
                    ...
                    items: [
                        {
                            imageSrc: "/images/v2/about/scene-engineer-desk.jpg",
                            imageAlt: "엔지니어 데스크에서 작업하는 장면",
                            caption: "설계와 범위를 함께 검토하는 회의. 무엇을 넣을지보다 무엇이 먼저 필요한지부터 정리합니다.",
                            imageWidth: 896,
                            imageHeight: 1200,
                        },
                        {
                            imageSrc: "/images/v2/about/scene-cable-macro.jpg",
                            imageAlt: "배선 케이블 클로즈업",
                            caption: "현장 설치와 점검 과정. 랙 배치, 배선, 연결 상태처럼 실제 운영에 영향을 주는 부분을 꼼꼼히 봅니다.",
                            imageWidth: 896,
                            imageHeight: 1200,
                        },
                        {
                            imageSrc: "/images/v2/about/scene-noc-night.jpg",
                            imageAlt: "야간 NOC 운영 환경",
