    ...
    "/service/network/design-build": page({
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    "배선과 정책이 따로 놀지 않도록\n현장 중심 네트워크를\n다시 설계합니다",
                    "신규 구축과 증설은 장비를 더 넣는 작업이 아니라, 서비스 흐름과 장애 영향 범위를 다시 정리하는 작업이어야 합니다. TechI는 코어, 액세스, 방화벽, 회선, 무선 구성을 한 번에 검토하고 실제 운영에 바로 이어지는 기준으로 구축합니다.",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "케이블이 연결되고 장비가 올라가는 순간보다 더 중요한 것은 그 다음입니다. 회선 상태, 링크 업다운, 정책 반영, 서비스 경로, 이중화 절체까지 확인되어야 비로소 구축이 끝납니다. TechI는 설치 사진보다 검증 기준이 남는 구축을 지향합니다.",
        ...
        sections: [
            ...
            section(
                ...
                mediaFeature({
                    ...
                    imageAlt: "보안 운영과 관제를 상징하는 컨트롤룸 이미지",
                    layout: "imageRight",
                    tone: "photo",
                    imageWidth: 4000,
                    imageHeight: 2667,
    ...
    "/service/network/ha-wireless": page({
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    "무선 품질과 이중화는\n장비 수량이 아니라\n절체 기준으로 결정됩니다",
                    "이중화와 무선 인프라는 장애가 났을 때 어떻게 버티는지가 먼저 정의되어야 합니다. TechI는 코어 절체, 링크 이중화, 무선 커버리지, 로밍 품질, 관리 포인트를 한 번에 검토해 실제 사용자가 체감하는 안정성을 설계합니다.",
                    "/images/hero-network.jpg",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "네트워크 이중화와 무선 인프라는 평소보다 장애 순간에 평가받습니다. 절체가 되더라도 서비스 영향 범위가 크면 의미가 없습니다. TechI는 끊김 없는 접근 경험과 빠른 원인 판단을 동시에 고려해 구조를 설계합니다.",
    ...
    "/service/storage-backup/storage": page({
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    "빠른 스토리지가 아니라\n운영과 보호까지 버티는 구조로\n스토리지를 설계합니다",
                    "스토리지는 단순 용량 증설보다 데이터 특성과 서비스 특성에 맞는 계층 구조가 중요합니다. TechI는 성능 요구, 성장 속도, 백업 연계, 복구 기준을 함께 고려해 실제 운영이 가능한 스토리지 구조를 제안합니다.",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "실무에서는 저장 공간보다 더 중요한 것이 데이터가 어떻게 생성되고, 얼마나 자주 읽히며, 언제 복구되어야 하는지입니다. TechI는 현장 운영 기준을 바탕으로 성능 계층과 보호 계층이 함께 맞물리는 구조를 설계합니다.",
    ...
    "/service/storage-backup/backup-restore": page({
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    "백업이 있다는 말보다\n얼마나 빨리 복구되는지가\n더 중요합니다",
                    "백업 체계는 저장 주기만으로 설명되지 않습니다. 어떤 데이터를 어느 시점으로, 누가, 어떤 절차로 복구하는지가 정의되어 있어야 운영 기준이 됩니다. TechI는 백업과 복구를 분리하지 않고 하나의 운영 흐름으로 설계합니다.",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "백업은 쌓여 있어도 복구 절차가 없다면 운영 기준이 되지 못합니다. TechI는 장애 순간 필요한 담당자, 데이터 범위, 복구 순서, 검증 결과까지 한 흐름으로 정리해 실제로 복구할 수 있는 체계를 만듭니다.",
    ...
    "/service/storage-backup/dr-bcp": page({
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    "재해복구는 문서가 아니라\n서비스를 다시 살리는 순서로\n설계되어야 합니다",
                    "DR과 BCP는 선언적 문구보다 우선순위와 절체 기준이 더 중요합니다. TechI는 서비스 중요도, 복구 시점, 대체 자원, 운영 역할을 함께 정리해 실제 위기 상황에서 실행 가능한 복구 체계를 설계합니다.",
                    "/images/hero-datacenter.jpg",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "재해복구 체계는 서버와 스토리지만으로 완성되지 않습니다. 연락 체계, 승인 절차, 복구 순서, 대체 업무 방식이 함께 정리되어야 실제 업무 연속성이 유지됩니다. TechI는 기술 구조와 운영 절차를 한 문서 체계로 연결합니다.",
    ...
    "/service/consulting/assessment": page({
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    "프로젝트를 시작하기 전에\n먼저 현재 구조를\n정확히 읽어야 합니다",
                    "인프라 진단은 체크리스트 점검이 아니라, 현재 구조에서 어떤 병목과 리스크가 반복되고 있는지를 읽는 과정입니다. TechI는 서버, 네트워크, 데이터 보호, 운영 체계를 함께 보고 실제 개선 과제로 이어지는 진단 결과를 제공합니다.",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "현황 진단의 가치는 보고서 분량에 있지 않습니다. 무엇이 실제 리스크인지, 어떤 순서로 손봐야 하는지, 지금 가능한 범위가 어디까지인지가 정리되어야 합니다. TechI는 운영 현실과 의사결정 관점에 맞는 진단 결과를 제공합니다.",
    ...
    "/service/consulting/architecture-roadmap": page({
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    "좋은 로드맵은\n큰 그림보다 먼저\n실행 순서를 분명히 합니다",
                    "아키텍처 로드맵은 기술 미래상을 그리는 문서가 아니라, 현재 환경에서 어떤 순서로 바꿔야 가장 안정적으로 전환할 수 있는지를 정리하는 계획이어야 합니다. TechI는 예산, 일정, 운영 인력까지 반영해 단계별 로드맵을 설계합니다.",
                    "/images/hero-cloud.jpg",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "장기 계획이 멋져 보여도 단계별 실행 조건이 없으면 프로젝트는 중간에 흔들립니다. TechI는 현황 진단 결과를 바탕으로 우선순위, 투자 타이밍, 전환 시나리오, 운영 인수 시점을 한 문서에 묶어 로드맵을 설계합니다.",
        ...
        sections: [
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "규정은 조직마다 다르지만, 실제로 필요한 것은 누가 어떤 조건에서 무엇을 검토하고 기록할지에 대한 기준입니다. TechI는 보안과 컴플라이언스를 조직의 운영 흐름 안으로 끌어들여 실행 가능한 형태로 정리합니다.",
                    imageSrc: "/images/security-control-room.jpg",
    ...
    "/service/maintenance/sla-support": page({
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    "지원 체계는\n빠른 답변보다 먼저\n명확한 기준이 필요합니다",
                    "유지보수는 연락처만 있어서는 운영되지 않습니다. 장애 등급, 응답 시간, 조치 범위, 보고 방식, 정기 점검 항목이 명확해야 실제 운영 품질이 안정됩니다. TechI는 SLA를 문장으로 두지 않고 운영 체계로 연결합니다.",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "유지보수 품질은 담당자 개인의 숙련도보다 체계에서 갈립니다. 어떤 이슈가 어떤 경로로 접수되고, 누가 판단하며, 어떤 형식으로 보고되는지가 정의되어야 운영이 안정됩니다. TechI는 현장과 운영실 사이의 흐름을 표준화합니다.",
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    ...
                    "정기 헬스체크는 단순 점검표 검토가 아닙니다. 용량 증가, 오류 로그, 성능 저하, 정책 누락, 구성 드리프트를 조기에 파악해 운영 리스크가 커지기 전에 대응하는 작업입니다. TechI는 정기 진단을 개선 과제로 연결합니다.",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "운영팀은 대부분 이상 징후를 느끼고 있지만, 우선순위를 정리할 기준이 부족한 경우가 많습니다. TechI는 정기 헬스체크를 통해 현재 상태를 수치와 구성 기준으로 확인하고, 실제 개선이 필요한 지점을 빠르게 분리해 드립니다.",
                    imageSrc: "/images/technical-design-review.jpg",
    ...
    "/service/maintenance/incident-recovery": page({
        ...
        sections: [
            ...
            section(
                ...
                heroBlock(
                    "장애 대응은\n빨리 복구하는 것만큼\n원인을 남기는 일이 중요합니다",
                    "장애 대응은 단기 복구와 재발 방지를 분리해서 보면 반복됩니다. TechI는 접수, 우선순위 판단, 원인 파악, 임시 복구, 영구 조치, RCA 정리까지 연결해 장애 대응 체계를 설계하고 운영합니다.",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    body: "운영 현장에서는 일단 살아나는 것이 중요하지만, 원인이 정리되지 않으면 같은 유형의 장애가 계속 반복됩니다. TechI는 복구 과정에서 필요한 로그, 확인 포인트, 보고 체계를 함께 관리해 대응 품질을 높입니다.",
                    imageSrc: "/images/dark-console-operator.jpg",
