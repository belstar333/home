        ...
        sections: [
            ...
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/server-build-engineer-desk.jpeg",
            ...
            section(
                "s6",
                "faq",
                faq("서버 구축·증설에 대해 자주 묻는 질문", [
                    {
                        q: "구축 기간은 보통 얼마나 걸리나요?",
                        a: "환경과 규모에 따라 다르지만, 중소규모 서버 구축은 설계 포함 2–4주, 대규모 데이터센터 이전은 2–3개월 정도를 기준으로 봅니다. 정확한 일정은 현황 파악 후 산정합니다.",
                    },
                    {
                        q: "기존 서비스 운영 중에 교체가 가능한가요?",
                        a: "네, 가능합니다. 전환 순서, 롤백 조건, 서비스 영향 최소화 방안을 먼저 설계한 뒤 단계적으로 진행합니다. 서비스 중단 없이 전환하는 방식이 테크아이의 기본 원칙입니다.",
                    },
                    {
                        q: "구축 이후 운영 지원도 받을 수 있나요?",
                        a: "네, 구축 완료 후 SLA 기반 유지보수, 정기 점검, 장애 대응 체계로 이어집니다. 인수 문서와 운영 기준도 프로젝트 산출물에 포함됩니다.",
                    },
                ])
            ),
        ],
    ...
    "/service/server/virtualization": page({
        ...
        sections: [
            ...
            section(
                "s3b",
                "cards",
                featureCards("다루는 가상화 영역", [
                    {
                        title: "VMware / Hyper-V / KVM",
                        desc: "운영 환경과 관리 인력에 맞는 하이퍼바이저를 선택하고, 초기 구조와 자원 정책을 함께 설계합니다.",
                    },
                    {
                        title: "VM 클러스터와 HA 구조",
                        desc: "노드 장애 시 VM 절체 순서와 클러스터 쿼럼 유지 조건을 설계 단계에서 정의합니다.",
                    },
                    {
                        title: "자원 풀과 운영 정책",
                        desc: "워크로드별 CPU·메모리 우선순위 분리, 스냅샷 정책, 변경 관리 기준을 표준화합니다.",
                    },
                    {
                        title: "플랫폼 전환과 마이그레이션",
                        desc: "P2V·V2V 이행 시나리오를 단계별로 구성하고 전환 검증 기준과 롤백 조건을 함께 정의합니다.",
                    },
                ])
            ),
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/server-virtualization-console.jpeg",
            ...
            section(
                "s6",
                "faq",
                faq("가상화·클러스터에 대해 자주 묻는 질문", [
                    {
                        q: "VMware, Hyper-V, KVM 중 어떤 플랫폼을 권장하나요?",
                        a: "플랫폼보다 현재 운영 환경과 관리 인력이 더 중요합니다. 기존 라이선스, 운영 숙련도, 확장 계획을 먼저 확인한 뒤 가장 현실적인 선택을 함께 결정합니다.",
                    },
                    {
                        q: "가상화 전환 중 서비스 중단이 발생하나요?",
                        a: "전환 순서와 HA 설계에 따라 무중단 또는 최소 중단으로 진행 가능합니다. 서비스 중요도별로 전환 시나리오를 먼저 설계하고 리허설 후 본 작업에 들어갑니다.",
                    },
                    {
                        q: "기존 가상화 환경을 점검만 받을 수도 있나요?",
                        a: "네, 신규 구축 없이 현재 가상화 구조의 리스크와 개선 포인트만 진단하는 것도 가능합니다. 인프라 진단 서비스에서 시작하시면 됩니다.",
                    },
                ])
            ),
        ],
    ...
    "/service/server/ops-monitoring": page({
        ...
        sections: [
            ...
            section(
                "s3b",
                "cards",
                featureCards("다루는 모니터링 영역", [
                    {
                        title: "Zabbix / Grafana / MRTG",
                        desc: "오픈소스 모니터링 도구를 환경에 맞게 구성하고, 수집 에이전트와 대시보드를 실제 운영에 맞게 조정합니다.",
                    },
                    {
                        title: "알림 정책과 에스컬레이션",
                        desc: "임계값 기준을 서비스 영향 중심으로 설정하고, 알림이 발생했을 때 누가 어떤 순서로 대응하는지 체계를 정의합니다.",
                    },
                    {
                        title: "운영 런북과 RCA 관리",
                        desc: "반복 장애 조치 절차를 런북으로 문서화하고, 장애 종료 후 원인 분석과 재발 방지 과제를 구조화합니다.",
                    },
                    {
                        title: "성능 지표와 정기 보고",
                        desc: "수집 범위를 정의하고, 운영 지표와 알림 이력을 주간·월간 보고서로 연결해 SLA 근거로 활용합니다.",
                    },
                ])
            ),
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/server-ops-noc-wide.jpeg",
        ...
        sections: [
            ...
            section(
                ...
                featureCards("설계 범위", [
                    {
                        title: "L2",
                        desc: "VLAN 분할 · STP · Trunk · 포트 보안",
                    },
                    {
                        title: "L3",
                        desc: "Subnetting · Static / OSPF / BGP 라우팅 · 게이트웨이",
                    },
                    {
                        title: "L4-7",
                        desc: "방화벽 ACL · Load Balancer · 인증 정책",
                    },
                    {
                        title: "무선",
                        desc: "SSID 설계 · VLAN 매핑 · 인증 정책",
                    },
                ])
            ),
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/network-design-whiteboard.jpeg",
                    imageAlt: "네트워크 설계 화이트보드 토폴로지 다이어그램",
                    layout: "imageRight",
                    tone: "photo",
                    imageWidth: 1600,
                    imageHeight: 1067,
            ...
            section(
                ...
                benefits("이런 프로젝트에서 주로 찾습니다", [
                    ...
                    "신규 사이트 개설 또는 데이터센터 이전과 함께 전체 네트워크 구조를 재정비해야 하는 경우",
                    "장비 EOL 교체 시점에 맞춰 네트워크 토폴로지와 정책 구조를 정리해야 하는 환경",
                ])
            ),
            section(
                "s6",
                ...
                faq("자주 묻는 질문", [
                    {
                        q: "구축 기간은 얼마나 걸리나요?",
                        a: "환경에 따라 다르지만 소규모 단일 사이트 구축은 3–4주, 이중화 구성이나 복수 층·사이트 구성은 6–10주 수준입니다. 일정 산정 전 현장 확인과 기존 구성 검토를 먼저 진행합니다.",
                    },
                    {
                        q: "서비스 중단 없이 구축할 수 있나요?",
                        a: "단계별 이행 계획을 사전에 수립하면 주요 구간의 중단 시간을 최소화할 수 있습니다. 야간·주말 작업, 롤백 시나리오, 서비스 검증 항목을 포함한 이행 계획서를 작업 전에 공유합니다.",
                    },
                    {
                        q: "구축 후 인수 문서는 어떻게 제공되나요?",
                        a: "네트워크 구성도, 장비 목록, IP 할당 현황, VLAN 정책 표, 케이블 경로, 점검 기준을 포함한 인수 문서를 납품 시 제공합니다. 운영팀이 바로 사용할 수 있는 형태로 정리합니다.",
                    },
                ])
            ),
        ],
    ...
    "/service/network/security": page({
        ...
        sections: [
            ...
            section(
                "s3b",
                "cards",
                featureCards("차세대 방화벽 벤더", [
                    { title: "Palo Alto", desc: "" },
                    { title: "Fortinet", desc: "" },
                    { title: "Check Point", desc: "" },
                    { title: "시큐아이", desc: "" },
                    { title: "안랩", desc: "" },
                ], "badges")
            ),
            section(
                "s3c",
                "cards",
                featureCards("대응 가능 보안 표준", [
                    { title: "ISMS-P", desc: "" },
                    { title: "망 분리 가이드라인", desc: "" },
                    { title: "개인정보보호법", desc: "" },
                ], "badges")
            ),
            section(
            ...
            section(
                ...
                faq("자주 묻는 질문", [
                    {
                        q: "기존 방화벽을 교체하지 않고 정책만 정리할 수 있나요?",
                        a: "네, 장비 교체 없이 기존 방화벽의 정책 현황 파악, 중복·충돌·미사용 룰 정리, 운영 기준 문서화 작업만 진행하는 것도 가능합니다. 장비 교체가 필요한 경우라면 진단 후 별도로 안내합니다.",
                    },
                    {
                        q: "망 분리 설계는 어느 범위까지 지원하나요?",
                        a: "업무망·서버망·관리망 구간 설계부터 외부 연계 구간, 원격 접속 경로, VPN 정책까지 포함합니다. 규제 대응이 필요한 경우에는 컴플라이언스 요건을 함께 검토하고 망 분리 방식을 결정합니다.",
                    },
                    {
                        q: "보안 감사 준비를 위한 문서화는 어느 수준으로 지원되나요?",
                        a: "정책 이력, 예외 승인 내역, 점검 결과서, 변경 관리 절차 등 내부 감사나 외부 인증 심사에 제출할 수 있는 문서 형태로 정리합니다. 요구 기준이 있다면 사전에 공유해 주시면 맞춤 지원이 가능합니다.",
                    },
                ])
            ),
        ],
    ...
    "/service/network/ha-wireless": page({
        ...
        sections: [
            ...
            section(
                "s3b",
                "cards",
                featureCards("다루는 표준·기술", [
                    {
                        title: "무선 표준",
                        desc: "Wi-Fi 6 · Wi-Fi 6E · Wi-Fi 7\n대응 가능 AP 벤더: Cisco · Aruba · Ruckus · Meraki",
                    },
                    {
                        title: "이중화 프로토콜",
                        desc: "HSRP · VRRP · GLBP · Stacking · MC-LAG\n레이어3 절체와 스태킹 기반 절체 모두 지원",
                    },
                ])
            ),
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/network-ha-ceiling-ap.jpeg",
                    imageAlt: "사무실 천장 무선 액세스 포인트 배치",
                    layout: "imageRight",
                    tone: "photo",
                    imageWidth: 1600,
                    imageHeight: 1067,
            ...
            section(
                "s5",
                "cards",
                featureCards("도입 이후 달라지는 것", [
                    { title: "장애나 회선 전환 시 서비스 중단 범위가 예측 불가", desc: "서비스 중단 범위가 예측 가능해집니다" },
                    { title: "무선 품질 이슈를 단순 민원으로 처리", desc: "구조적 문제로 분류해 대응합니다" },
                    { title: "장애 발생 시 절체 경로와 원인 구간 불명", desc: "절체 경로와 원인 구간을 빠르게 파악합니다" },
                    { title: "무선 증설과 이중화가 따로 진행", desc: "같은 기준 아래에서 이어집니다" },
                ], "before-after")
            ),
            section(
                "s6",
                ...
                faq("자주 묻는 질문", [
                    {
                        q: "이중화 구성 시 절체 시간은 얼마나 되나요?",
                        a: "구성 방식에 따라 다릅니다. HSRP/VRRP 기반 레이어3 절체는 초 단위, 스패닝트리 기반은 수십 초 수준입니다. 서비스 특성에 맞게 절체 방식을 선택하고, 테스트 시나리오를 통해 실제 절체 시간을 확인한 뒤 기준으로 확정합니다.",
                    },
                    {
                        q: "무선 커버리지 음영 구간은 어떻게 찾나요?",
                        a: "현장 사이트 서베이를 통해 층별 신호 강도, 채널 간섭, 사용자 밀도를 측정합니다. 측정 결과를 바탕으로 AP 위치와 수량을 조정하며, 필요시 기존 AP를 재배치하는 것만으로 해결되는 경우도 많습니다.",
                    },
                    {
                        q: "기존 AP를 그대로 활용하면서 무선 품질을 개선할 수 있나요?",
                        a: "벤더와 모델에 따라 다르지만, 채널 구성·출력 조정·로밍 정책 변경만으로 품질이 개선되는 경우도 있습니다. 현장 서베이 결과에 따라 교체 없이 조정 가능한 범위를 먼저 확인하고 투자 계획을 세웁니다.",
                    },
                ])
            ),
        ],
    ...
    "/service/storage-backup/storage": page({
        ...
        sections: [
            ...
            section(
                "s3b",
                "cards",
                featureCards("다루는 스토리지 영역", [
                    {
                        title: "블록 스토리지",
                        desc: "SAN / FC · iSCSI · NVMe-oF — 고성능 워크로드(DB, VM)에 적합한 블록 레벨 저장 구조를 설계합니다.",
                    },
                    {
                        title: "파일 스토리지",
                        desc: "NAS · 분산 파일시스템 · 클라우드 파일 — 파일 공유, 백업 대상, 협업 환경에 맞는 파일 계층을 구성합니다.",
                    },
                    {
                        title: "오브젝트 · SDS",
                        desc: "S3 호환 · Ceph · MinIO — 대용량 비정형 데이터와 아카이브 계층을 위한 소프트웨어 정의 스토리지를 구성합니다.",
                    },
                    {
                        title: "대응 가능 벤더",
                        desc: "HPE · Dell EMC · NetApp · Pure Storage · 시놀로지 — 보유 장비와 운영 환경을 먼저 확인 후 권고안을 제시합니다.",
                    },
                ])
            ),
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/storage-tiering-rack.jpeg",
            ...
            section(
                ...
                faq("자주 묻는 질문", [
                    {
                        q: "기존 스토리지 장비를 유지하면서 설계 개선이 가능한가요?",
                        a: "네, 현재 보유 장비의 성능·용량·기능 한계를 먼저 파악하고, 교체 없이 구성 변경이나 계층 재설계로 개선할 수 있는 범위를 정리합니다. 장비 교체가 필요한 경우에는 시점과 우선순위를 나눠 단계적으로 계획을 세웁니다.",
                    },
                    {
                        q: "SAN과 NAS 중 어느 쪽이 우리 환경에 맞는지 어떻게 판단하나요?",
                        a: "워크로드 특성(DB·VM인지, 파일 공유·백업 대상인지), 프로토콜 요구사항, 성능 기준, 관리 인력 수준을 함께 검토합니다. 단일 방식이 아닌 혼합 구성이 필요한 경우도 많아 실제 운영 환경을 파악한 뒤 권고안을 제시합니다.",
                    },
                    {
                        q: "용량 계획은 얼마나 앞을 내다보고 수립하나요?",
                        a: "일반적으로 3년 기준 성장률을 반영해 계획을 수립합니다. 데이터 증가 속도가 불규칙한 경우에는 증설 트리거 조건(사용률 임계값 등)을 함께 정의해 실제 필요 시점에 맞게 확장할 수 있도록 합니다.",
                    },
                ])
            ),
        ],
    ...
    "/service/storage-backup/backup-restore": page({
        ...
        sections: [
            ...
            section(
                "s3b",
                "cards",
                featureCards("다루는 백업 영역", [
                    {
                        title: "백업 솔루션",
                        desc: "Veeam · Commvault · Rubrik · 오픈소스 — 환경과 예산에 맞는 솔루션을 확인한 뒤 구성 방향을 제안합니다.",
                    },
                    {
                        title: "백업 정책",
                        desc: "GFS · Incremental · Synthetic Full · Forever Incremental — 데이터 중요도와 복구 목표에 맞는 스케줄을 설계합니다.",
                    },
                    {
                        title: "보존 정책",
                        desc: "Hot · Warm · Cold · Archive 티어링 — 보존 기간과 접근 빈도에 따라 저장 계층을 나눠 비용과 복구 속도를 균형 있게 설계합니다.",
                    },
                    {
                        title: "복구 검증",
                        desc: "파일 단위 · VM 단위 · 서비스 단위 리허설 — 정기적인 복구 검증으로 실제 복구 가능 시간을 측정하고 이력을 남깁니다.",
                    },
                ])
            ),
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/backup-restore-verification.jpeg",
    ...
    "/service/storage-backup/dr-bcp": page({
        ...
        sections: [
            ...
            section(
                "s3b",
                "cards",
                featureCards("다루는 DR 옵션", [
                    {
                        title: "RPO 범위",
                        desc: "분 단위 · 시간 단위 · 일 단위 구현 가능 — 데이터 중요도와 복제 방식에 따라 실현 가능한 복구 시점 목표를 설계합니다.",
                    },
                    {
                        title: "RTO 범위",
                        desc: "분 단위 · 시간 단위 · 일 단위 구현 가능 — 서비스 우선순위와 절체 자원 규모에 따라 목표 복구 시간을 설정합니다.",
                    },
                    {
                        title: "사이트 옵션",
                        desc: "Hot Site · Warm Site · Cold Site · 클라우드 DR — 비용과 복구 목표를 함께 고려해 현실적인 사이트 구성을 제안합니다.",
                    },
                    {
                        title: "BCP 산출물",
                        desc: "업무 영향 분석 · 복구 절차서 · 훈련 시나리오 · 개정 기록 — 실제 위기 상황에서 바로 사용할 수 있는 형태로 문서를 정리합니다.",
                    },
                ])
            ),
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/dr-bcp-runbook-detail.jpeg",
        ...
        sections: [
            ...
            section(
                ...
                featureCards("진단은 이 세 가지를 분명하게 만드는 작업입니다", [
                    {
                        title: "현재 구조 파악",
                        desc: "장비 현황보다 서비스 흐름과 운영 의존성을 먼저 봅니다. 장애 발생 지점을 통해 구조적 문제를 읽어냅니다.",
                    },
                    {
                        title: "리스크 우선순위화",
        ...
        sections: [
            ...
            section(
                ...
                featureCards("로드맵 설계의 핵심 요소", [
                    {
                        title: "단계별 전환 범위",
                        desc: "한 번에 바꾸지 않고 서비스 영향이 적은 순서로 분할해 전환 계획을 세웁니다. 예: 비핵심 워크로드 → 백업·DR → 핵심 트랜잭션 순서로 리스크를 분산합니다.",
                    },
                    {
                        title: "투자 우선순위",
                        desc: "효과가 큰 과제부터 실행할 수 있도록 비용·리스크·운영 편익을 함께 비교합니다. 예산 제약이 있을 때도 단계를 나눠 의미 있는 진전을 만들 수 있습니다.",
                    },
                    {
                        title: "운영 조직 반영",
                        desc: "기술적으로 가능한 시나리오가 아니라 실제 운영 조직이 감당 가능한 시나리오를 설계합니다. 인수 시점과 교육 범위까지 계획에 포함합니다.",
                    },
                ])
            ),
            section(
            ...
            section(
                "s5",
                "cards",
                featureCards("정리 이후 달라지는 것", [
                    {
                        title: "큰 그림만 있는 로드맵",
                        desc: "무엇부터 시작할지 조직 내 합의가 빨라집니다.",
                    },
                    {
                        title: "예산·일정에 막히는 계획",
                        desc: "단계별로 추진 가능한 기준이 생겨 유연하게 진행됩니다.",
                    },
                    {
                        title: "영역별로 흩어진 개선 과제",
                        desc: "인프라·보안·운영 과제를 하나의 흐름으로 관리합니다.",
                    },
                    {
                        title: "단기 처방과 장기 전환 계획 혼재",
                        desc: "분리된 단계 계획으로 더 현실적인 추진이 가능해집니다.",
                    },
                ], "before-after")
            ),
        ],
        ...
        sections: [
            ...
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/Security_operations_center_at_night.jpeg",
                    imageAlt: "야간 보안 관제 센터에서 모니터를 통해 운영 현황을 확인하는 장면",
                    layout: "imageRight",
                    tone: "photo",
                    imageWidth: 4000,
                    imageHeight: 2667,
            ...
            section(
                "s5",
                "cards",
                featureCards("대응 가능한 보안·컴플라이언스 기준", [
                    { title: "ISMS-P", desc: "" },
                    { title: "ISO 27001", desc: "" },
                    { title: "SOC 2", desc: "" },
                    { title: "개인정보보호법", desc: "" },
                    { title: "전자금융감독규정", desc: "" },
                    { title: "CSAP", desc: "" },
        ...
        sections: [
            ...
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/maintenance-sla-matrix-desk.jpeg",
                    imageAlt: "SLA 지원 체계 산출물",
                    layout: "imageRight",
                    tone: "photo",
                    imageWidth: 1600,
                    imageHeight: 1066,
            ...
            section(
                "s5",
                "cards",
                featureCards("도입 이후 운영이 달라지는 부분", [
                    { title: "장애 접수와 우선순위 분류 기준이 없음", desc: "더 빠르고 일관된 분류가 가능합니다" },
                    { title: "담당자 변경 시 품질 편차 발생", desc: "서비스 품질 편차가 줄어듭니다" },
                    { title: "반복 이슈가 종료 후 사라짐", desc: "보고와 개선 과제로 연결됩니다" },
                    { title: "지원 범위와 책임 구간이 불명확", desc: "커뮤니케이션 비용이 줄어듭니다" },
                ], "before-after")
            ),
        ],
    }),
        ...
        sections: [
            ...
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/v2/service/maintenance-incident-noc-alert.jpeg",
                    imageAlt: "장애 대응 NOC 운영 화면",
                    layout: "imageRight",
                    tone: "photo",
                    imageWidth: 1600,
                    imageHeight: 1066,
            ...
            section(
                ...
                "cards",
                featureCards("도입 이후 달라지는 것", [
                    { title: "장애 발생 시 누구를 먼저 깨워야 할지 모름", desc: "대응 순서가 빨라집니다" },
                    { title: "반복 장애가 개별 이슈로 누적", desc: "구조 개선 대상으로 관리됩니다" },
                    { title: "복구 이후 보고와 RCA가 비표준화", desc: "표준화된 커뮤니케이션 비용이 줄어듭니다" },
                    { title: "운영 품질이 사람 의존", desc: "체계 의존으로 바뀝니다" },
                ], "before-after")
            ),
        ],
    }),
