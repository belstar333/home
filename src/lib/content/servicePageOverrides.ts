                ...
                featureCards(
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            imageSrc: "/images/storage-array-rack.jpg",
                            imageAlt: "스토리지 어레이 장비 정면 환경",
                        },
                        {
                            title: "컨설팅",
                            desc: "보고서로 끝나는 진단은 의미가 없습니다. 현황 분석에서 실행 가능한 로드맵과 우선순위까지 연결합니다.",
                            href: "/service/consulting",
                            imageSrc: "/images/consulting-whiteboard.jpg",
                            imageAlt: "화이트보드 앞에서 IT 인프라 구조를 그리는 장면",
                        },
                        {
                            title: "유지보수",
                    ...
                    items: [
                        {
                            ...
                            imageAlt: "서버 설계 문서와 다이어그램을 검토하는 엔지니어",
            ...
            section(
                ...
                imageGallery({
                    ...
                    items: [
                        ...
                        {
                            imageSrc: "/images/server-rack-closeup.jpg",
                            imageAlt: "서버 랙 내부 케이블링 정면 클로즈업",
        ...
        sections: [
                ...
                imageGallery({
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            imageAlt: "다수 운영자가 벽면 디스플레이와 함께 네트워크 상황을 모니터링하는 관제 센터",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/server-design-review.jpg",
                    imageAlt: "네트워크 구조와 운영 기준을 화이트보드와 다이어그램으로 검토하는 장면",
                    layout: "imageRight",
                    tone: "photo",
                    imageWidth: 1600,
                    imageHeight: 1067,
        ...
        sections: [
            ...
            section(
                ...
                imageGallery({
                    ...
                    items: [
                        ...
                        {
                            imageSrc: "/images/storage-dr-site.jpg",
                            imageAlt: "DR 사이트 또는 이중화 구성 랙 환경",
            ...
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/storage-backup-verify.jpg",
                    imageAlt: "복구 테스트와 백업 검증 결과를 확인하는 장면",
                    layout: "imageLeft",
                    tone: "photo",
                    imageWidth: 1600,
                    imageHeight: 1067,
        ...
        sections: [
            ...
            section(
                ...
                mediaFeature({
                    ...
                    imageSrc: "/images/consulting-report-review.jpg",
                    imageAlt: "진단 보고서와 실행 과제를 클로즈업으로 검토하는 장면",
                    layout: "imageRight",
                    tone: "photo",
                    imageWidth: 1600,
                    imageHeight: 1067,
                ...
                imageGallery({
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            imageAlt: "현장에서 랙 앞에 서서 정기 점검을 수행하는 엔지니어",
                        ...
                        },
                        {
                            ...
                            imageAlt: "점검 결과서와 월간 보고서를 검토하는 장면",
